                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="agent_name" id="agent_name" placeholder="Enter the Agent/organization name" class="form-control" REQUIRED>  
                                    </div>
                
                                    <div class="col-12">
                                        <!-- <label> Agent ID :</label> -->
                                        <input type="hidden" name="agent_id" id="agent_id" placeholder="Enter the Agent ID" class="form-control">
                                    </div>
                
                                    <div class="col-12">
                                        <label> Reg No :</label>
                                        <span style="color:red;">*</span>
                                        <input type="text" name="reg_no" id="reg_no" placeholder="enter the agent registration number" class="form-control" REQUIRED>
                                    </div>
                
                                    <div class="col-12">
                                        <label> Address :</label>
                                        <span style="color:red;">*</span>
                                        <input type="text" name="address" id="address" placeholder=" no / Street/ lane / City" class="form-control" REQUIRED />
                                    </div>
                
                                    <div class="col-12">
                                        <label> Contact No :</label>
                                        <span style="color:red;">*</span>
                                        <input type="text" name="contact" id="contact" placeholder="07XXXXXXXX" class="form-control" REQUIRED minlength="10" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                    </div>

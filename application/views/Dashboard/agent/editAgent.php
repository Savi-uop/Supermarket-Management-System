            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="agent_name" id="agent_name" class="form-control" value ="<?php echo $detail->agent_name; ?>" REQUIRED>  
                    </div>

                    <div class="col-12">
                        <!-- <label> Agent ID :</label> -->
                        <input type="hidden" name="agent_id" id="agent_id" class="form-control" value ="<?php echo $detail->agent_id; ?>">
                    </div>

                    <div class="col-12">
                        <label> Reg No :</label>
                        <span style="color:red;">*</span>
                        <input type="text" name="reg_no" id="reg_no" class="form-control" value ="<?php echo $detail->reg_no; ?>" REQUIRED>
                    </div>

                    <div class="col-12">
                        <label> Address :</label>
                        <span style="color:red;">*</span>
                        <input type="text" name="address" id="address" class="form-control" value ="<?php echo $detail->address; ?>" REQUIRED>
                    </div>

                    <div class="col-12">
                        <label> Contact No :</label>
                        <span style="color:red;">*</span>
                        <input type="text" name="contact" id="contact" class="form-control" value ="<?php echo $detail->contact; ?>" REQUIRED minlength="10" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                    </div>

                    <div class="col-12">
                        <label> Name of the agent head :</label>
                        <input type="text" name="head_name" id="head_name" class="form-control" value ="<?php echo $detail->head_name; ?>">
                    </div>

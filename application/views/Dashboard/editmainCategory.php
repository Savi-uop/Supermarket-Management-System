      ...
      <div class="container-fluid">
        ...
        <!-- Main row -->
            ...
            <div class="card">
              ...
              <body>
                <div class="container">
                    <form action="http://localhost/Supermarket1/MainCategoryController/updateCategory/" method="POST" >
                  
                        <div class="col-12">
            
                            <h3 class="text-center"><span class="badge badge-pill badge-primary">Category editing form</span></h3>
                        </div>

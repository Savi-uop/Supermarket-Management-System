        ...
        <!-- Main row -->
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <span class="badge rounded-pill bg-dark"><h3 class="card-title">Daily Reportt</h3></span>
                

                <div class="card-tools">
                    <a href="#" class="btn btn-sm btn-success">Daily</a> 
                    <a href="#" class="btn btn-sm btn-secondary">Weekly</a> 
                  ...
                  <table class="table">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>10</td>
                            <td>P-2345</td>
                            <td>RICE SAMBA 5KG PACK</td>
                            <td> 17</td>
                            <td> 2021/01/28</td>
                            <td>625.00 </td>
                            <td align="right">10625.00</td>
                        ...
                        <tr>
                            ...
                            <td align="right"><b>60865.00</b></td>

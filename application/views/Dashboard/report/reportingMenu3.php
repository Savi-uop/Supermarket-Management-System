    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="d-grid gap-3">
                <h2> <span class="badge bg-secondary col-12"> Report Module</span></h1>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-9 align-items-start">
                        ...
                        <form action="http://localhost/Supermarket1/index.php/ReportController/ReportHandling/" method="POST">
                            <br><br>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                          ...
                                          <div  class="col">
                                            <br> 
                                            <div class="col"><button class="btn btn-success btn-lg" id="daily" value ="daily" name ="report" type="submit">Daily Income <i class="fas fa-arrow-circle-right"></i></button></div>
                                          </div>
                                    </div>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col">
                                              <br>
                                              <div class="col"><button class="btn btn-success btn-lg" id="monthly" value="monthly" name="report" type="submit">Monthly Income <i class="fas fa-arrow-circle-right"></i></button></div>
                                          </div>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col">
                                              <br>
                                              <div class="col"><button class="btn btn-success btn-lg" id="anualy" value="anualy" name="report" type="submit">Anual Income <i class="fas fa-arrow-circle-right"></i></button></div>
                                          </div>

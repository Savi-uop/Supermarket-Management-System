            ...
            <div class="card">
              <div class="card-header border-transparent">
                ...
                <div class="card-tools">
                    <a href="http://localhost/Supermarket1/ProductController/" class="btn btn-sm btn-info float-right">Add Product</a>
                  ...
                  <table border="1" class="table table-striped table-hover">
                    ...
                    <?php foreach($user1 as $row): ?>
                        <tr>
                            ...
                            <td> <img src="http://localhost/Supermarket1/upload/<?php echo $row['image']; ?>" width="100" height="100"></td>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="editUser/<?php echo $row['id']; ?>"><button type="button" class="btn btn-sm btn-success" name="edit" >Edit</button></a>
                                    &nbsp;<a href="deleteUser/<?php echo $row['id']; ?>"><button type="button" class="btn btn-sm btn-danger" name="delete" >Delete</button></a>
              ...
              <div class="card-footer clearfix">
                ...
                <a href="javascript:void(0)" class="btn btn-sm btn-info float-right">View All Category</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->

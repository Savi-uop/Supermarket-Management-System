        ...
        <!-- Main row -->
            ...
            <div class="card">
              ...
              <div class="container">
                        ...
                        <form action="http://localhost/Supermarket1/index.php/UserController/addUser/" method="POST" enctype="multipart/form-data">
                            <br>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="fname" id="fname" placeholder="Enter user first name" class="form-control">  
                                            </div>
                                            <div class="col-6">
                                                <label > Last Name :</label>
                                                <input type="text" name="lname" id="lname" placeholder="Enter user last name" class="form-control">  
                                            </div>
                                        </div>    
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="contact" id="contact" placeholder="07xxxxxxxx" class="form-control" max-lenth="10">  
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-6">
                                                <label> NIC No.</label>
                                                <input type="text" name="nic" id="nic" placeholder="enter national identity card number" class="form-control">  
                                            </div>
                                            <div class="col-6">
                                                <label>User Id</label>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" name="address1" id="address1" placeholder=" no /name" class="form-control">
                                            </div>
                                            <div class="col">
                                                <label>Address line2</label>
                                                <input type="text" name="address2" id="address2" placeholder="lane/street" class="form-control">
                                            </div>
                                            <div class="col">
                                                <label>Address line3</label>
                                                <input type="text" name="address3" id="address3" placeholder="city" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="email" name="email" id="email" placeholder="abc@gmail.com" class="form-control">
                                            </div>

        ...
        <div class="contentainer">
            <span class="card-body"> 
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <h5 class="text-center">Sales of   
                        <?php 
                                echo " ".$date;
                        ?>
                        </h5>
                    </div>
                    <div class="col-4 pull-right"><button type="button" class="btn btn-outline-success btn-lg"><a href="http://localhost/Supermarket1/ReportController/SalesReports/">Prev</a></button></div>
        ...
        <?php if(empty($sold_items)){ ?>
            <div class="card-body">
                <div class="alert alert-danger" role="alert">
                    <h4 class="text-lg-center text-danger">No Records Found on this date!</h4>
                </div>   
            </div>
            <?php }else{?>
                <div class="container">
